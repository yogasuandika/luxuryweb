...
function accourdion(){
    const accordionContainer = document.getElementsByClassName("accourdion");
    ...
    for(let index=0; index< accordionContainer.length; index++){
        ...
        button.addEventListener("click", onClickAccourdion);

        e.getElementsByTagName("h5")[0].append(button);
    }
}

if(window.innerWidth < 768) window.addEventListener("load", accourdion)